...
**Input:**
```
onboarding_welcome_title = Welcome to YourApp
  it = Benvenuti a YourApp
  el = Καλώς ήλθατε στο YourApp
  cs = Vítejte ve YourApp
  ro = Bun venit la YourApp
  sl = Dobrodošli v YourApp
  sk = Vitajte vo YourApp
