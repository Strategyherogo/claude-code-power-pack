...
**Input:** "draft outreach to the Head of Engineering at Acme Corp"
...
```markdown
# Outreach Draft: Alex Chen @ Notion

## Research Summary
**Target:** Alex Chen, Head of Engineering at Acme Corp
...
**To:** alex@acmecorp.example
**Subject:** Acme's AI scaling + a thought
